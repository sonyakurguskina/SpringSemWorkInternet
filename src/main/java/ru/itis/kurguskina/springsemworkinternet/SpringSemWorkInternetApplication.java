package ru.itis.kurguskina.springsemworkinternet;
...
public class SpringSemWorkInternetApplication {
    @Bean
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringSemWorkInternetApplication.class, args);
    }
